...
- Regression Results:  
  ...
  + Assumption of distance to stadium might be problematic.  
- Further analysis needed:  
  + Find data that includes preferred team for each agent  
  + Look at data with applications from May-September (soccer off-season) => is there a statistical difference?  
  + Evaluate lagged effects: if a team loses => did they apply the next day or the day before? 
]
---
