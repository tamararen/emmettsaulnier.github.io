...
```
- Evaluated households within 20 mi (median distance) of LIGA MX stadiums: 
  + Probability of applying on gamedays for all agents
  + Probability of paying back loans
]
.pull-right[
- Logit Regression - Propensity score matching 
  + "Treated" and "control" groups: well-balanced
  + Fixed time effects 
  + State fixed effects might be multicollinear with "treatment" dummy
  + Couldn't evaluate specific teams and the effect of winning due to Mexico City sharing three teams
- Regression Results and Conclusion 
  + Inconclusive - no significant results
